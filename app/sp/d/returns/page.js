...
import { Box, Grid, Button, Chip, Container, FormControl, IconButton, InputLabel, MenuItem, Select, Table, TableBody, TableCell, TableHead, TableRow, Tooltip, Typography, OutlinedInput } from "@mui/material"
      ...
      <Container maxWidth="xl">
        <Grid container justifyContent="space-between" alignItems="center" py={3}>
          ...
          <Grid item xs={8} container justifyContent="flex-end" alignItems="center" gap={1}>
            ...
            <Button variant="contained" onClick={() => handleLink("/sp/d/return")}>New</Button>
          </Grid>
        </Grid>
      </Container>
      <Table size="small">
            ...
            return (
              <TableRow key={_return.id.toString()}>
                ...
                <TableCell align="center">
                  ...
                  <Tooltip title="View" placement="top"><IconButton color="primary" onClick={() => handleLink(`/sp/d/return/${_return.id}`)}><AssignmentOutlined /></IconButton></Tooltip>
                  <Tooltip title="Edit" placement="top"><IconButton color="primary" onClick={() => handleLink(`/sp/d/return?id=${_return.id}`)}><EditOutlined /></IconButton></Tooltip>
                  {userState.warehouseUser && (
                    !_return.trash ? (
