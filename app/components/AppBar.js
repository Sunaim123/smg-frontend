...
export default function AppAppBar() {
  ...
  return (
    <AppBar
      position="fixed"
      sx={{ boxShadow: 0, bgcolor: "transparent", backgroundImage: "none", mt: 10, pr: 2 }}
    >
      <Container maxWidth="lg">
        <StyledToolbar variant="dense" disableGutters>
          ...
          >
            <Button color="primary" variant="text" size="small" href="/auth/signin" LinkComponent={Link}>Sign in</Button>
            <Button color="primary" variant="contained" size="small" href="/auth/signup" LinkComponent={Link}>Sign up</Button>
          </Box>
