...
export default function Permissions() {
  ...
  useEffect(() => {
    if (userState.permissions && !userState.permissions["UPDATE_ROLE"]) router.replace("/dashboard")
