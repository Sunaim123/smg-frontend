    ...
    <Auth>
      ...
      <Container maxWidth="xl">
        <Box display="flex" justifyContent="space-between" alignItems="center" my={3}>
          <Grid item xs={3}>
            <Typography variant="h4" fontWeight={700}>Inventory Orders</Typography>
          </Grid>
            ...
            return (
              <TableRow key={order.id.toString()}>
                ...
                <TableCell align="center">
                  <IconButton color="primary" size="small" onClick={() => router.push(`inventory-order/${order.id}`)}><AssignmentOutlined /></IconButton>
                  {userState.warehouseUser && (
                    !order.trash ? (
